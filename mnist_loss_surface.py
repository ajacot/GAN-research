...
learning_rate = tf.train.exponential_decay(20.0, global_step,
                                           100.0, 0.9)
...
dd = 4
[X1], vs0 = net.conv_net([X], [1, 8, dd], [3, 2], [2, 2], "D_conv", True)
...
def converge(epochs = 600, batch_size  = 64*2, direc = 1.0):
